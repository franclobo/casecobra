...
const OrderReceivedEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>EL resumen de tu orden y el tiempo estimado de entrega</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              Estamos preparando todo para la entrega y te notificaremos una vez
              que tu paquete haya sido enviado. La entrega suele tardar 2 días.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              Si tienes alguna pregunta sobre tu orden, no dudes en contactarnos
              con tu número de orden y estaremos encantados de ayudarte.
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Contáctanos si tienes alguna pregunta. (Si respondes a este
                correo electrónico, no podremos verlo).
              </Text>
            </Row>
            <Row>
